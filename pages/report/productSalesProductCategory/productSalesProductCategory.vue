  ...
  export default {
    data() {
      ...
      return {
        ...
        canvasId: "productSalesProductCategory",
        data: {},
        tableHead: [],
        tableColumns: [],
        tableData: [],
    ...
    async onLoad() {
      ...
      uni.setNavigationBarTitle({
        title: `${featureLabels['product']}销售按${featureLabels['product_category']}汇总`
      })
    ...
    methods: {
      ...
      fetchData(){
        ...
        reportCenterApi.product_sales(filters).then((res) => {
          ...
          this.tableHead = [featureLabels["product_category"], "销量", "数量"];
          this.tableColumns = ["x", "product_category", "amount", "quantity"];
