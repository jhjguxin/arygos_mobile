  ...
  export default {
    data() {
      return {
        ...
        canvasId: "receivedPaymentCountDepartment",
        data: {},
        tableHead: [],
        tableColumns: [],
        tableData: [],
    ...
    async onLoad() {
      ...
      uni.setNavigationBarTitle({
        title: `${featureLabels['received_payment']}金额按部门排名`
      })
    ...
    methods: {
      ...
      fetchData(){
        ...
        reportCenterApi.received_payment_amount(filters).then((res) => {
          let {
            data: {
              data
            },
